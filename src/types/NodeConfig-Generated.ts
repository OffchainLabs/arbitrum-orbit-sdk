...
//
// IMAGE: offchainlabs/nitro-node:v2.1.2-4c55843-dev
// TIMESTAMP: 2024-01-05T15:18:30.648Z
//
// ---
  ...
  'node': {
    ...
    'data-availability': {
      ...
      'rest-aggregator': {
        ...
        'online-url-list-fetch-interval': number;
        ...
        'strategy-update-interval': number;
        'sync-to-storage': {
    ...
    'feed': {
      input: {
        ...
        'reconnect-initial-backoff': number;
        /** maximum duration to wait before reconnect (default 1m4s) */
        'reconnect-maximum-backoff': number;
      ...
      output: {
        ...
        'connection-limits': {
          ...
          'reconnect-cooldown-period': number;
        };
    ...
    'forwarder': {
      ...
      'idle-connection-timeout': number;
    ...
    'rpc': {
      ...
      'classic-redirect-timeout': number;
    ...
    'seq-coordinator': {
      ...
      'handoff-timeout': number;
      /** (default 1m0s) */
      'lockout-duration': number;
      /** (default 30s) */
      'lockout-spare': number;
      ...
      'safe-shutdown-delay': number;
      /** (default 24h0m0s) */
      'seq-num-duration': number;
      'signer': {
        'ecdsa': {
          /** accept verified message from sequencer (default true) */
          'accept-sequencer': boolean;
    ...
    'sequencer': {
      ...
      'nonce-failure-cache-expiry': number;
    ...
    'staker': {
      ...
      'make-assertion-interval': number;
    ...
    'transaction-streamer': {
      ...
      'execute-message-loop-delay': number;
