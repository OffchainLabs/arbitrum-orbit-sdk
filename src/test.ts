const x = [
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'contract IInbox', name: 'inbox', type: 'address' },
          ...
          { internalType: 'contract IRollupAdmin', name: 'rollupAdminLogic', type: 'address' },
  ...
  {
    inputs: [{ internalType: 'contract IInbox', name: 'newInbox', type: 'address' }],
    name: 'setInbox',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
