export const sequencerInboxABI = [
  {
    inputs: [
      ...
      { internalType: 'bool', name: '_isDelayBufferable', type: 'bool' },
    ],
  ...
  { inputs: [], name: 'BadBufferConfig', type: 'error' },
  ...
  { inputs: [], name: 'InvalidDelayedAccPreimage', type: 'error' },
  {
    inputs: [{ internalType: 'bytes1', name: '', type: 'bytes1' }],
    name: 'InvalidHeaderFlag',
    type: 'error',
  },
  { inputs: [], name: 'KeysetTooLarge', type: 'error' },
  ...
  { inputs: [], name: 'NotDelayBufferable', type: 'error' },
  ...
  { inputs: [], name: 'RollupNotChanged', type: 'error' },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'newBatchPosterManager', type: 'address' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'batchPoster', type: 'address' },
      { indexed: false, internalType: 'bool', name: 'isBatchPoster', type: 'bool' },
    ],
    name: 'BatchPosterSet',
    type: 'event',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bool', name: 'isSequencer', type: 'bool' },
    ],
    name: 'SequencerSet',
    type: 'event',
  },
  ...
  },
  {
    inputs: [
      ...
      {
        components: [
          { internalType: 'bytes32', name: 'beforeDelayedAcc', type: 'bytes32' },
          {
            components: [
              ...
              { internalType: 'uint256', name: 'inboxSeqNum', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint64', name: 'replenishRateInBasis', type: 'uint64' },
      { internalType: 'uint64', name: 'prevSequencedBlockNumber', type: 'uint64' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
