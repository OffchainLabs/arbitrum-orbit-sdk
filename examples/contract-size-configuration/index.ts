...
async function main() {
  ...
  // set MaxCodeSize and MaxInitCodeSize parameters to increase contract size on the chain
  const chainConfig = prepareChainConfig({
    chainId,
    arbitrum: { InitialChainOwner: deployer.address, DataAvailabilityCommittee: true, MaxCodeSize: 40000, MaxInitCodeSize: 80000},
  });
